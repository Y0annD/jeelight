...
public enum Method {
	...
	SET_POWER("set_power", String.class, String.class, Integer.class), TOGGLE("toggle"), SET_DEFAULT("set_default"),
	START_CF("start_cf", Integer.class, Integer.class, String.class), STOP_CF("stop_cf"),
	SET_SCENE("set_scene", String.class, Integer.class, Integer.class),
	CRON_ADD("cron_add", Integer.class, Integer.class), CRON_GET("cron_get", Integer.class),
	CRON_DEL("cron_del", Integer.class), SET_ADJUST("set_adjust", String.class, String.class),
	SET_MUSIC("set_music", Integer.class, String.class, Integer.class), SET_NAME("set_name", String.class),
	...
	BG_SET_CT_ABX("bg_set_ct_abx", Integer.class, String.class, Integer.class), BG_STOP_CF("bg_stop_cf"),
	BG_SET_SCENE("bg_set_scene", String.class, Integer.class, Integer.class), BG_SET_DEFAULT("bg_set_default"),
	...
	BG_SET_ADJUST("bg_set_adjust", String.class, String.class), BG_TOGGLE("bg_toggle"), DEV_TOGGLE("dev_toggle"),
	ADJUST_BRIGHT("adjust_bright", Integer.class, Integer.class), ADJUST_CT("adjust_ct", Integer.class, Integer.class),
	 ...
	 * @param paramTypes types of each parameter
	 */
	...
	/**
	 * Check that method is correctly formated.
	 * 
	 * @param parameters array of parameters
	 * @throws ParameterException exception of parameter type
	 */
		...
		for (int i = 0; i < parameters.length; i++) {
			if (!parameters[i].getClass().equals(mParamTypes.get(i))) {
				throw new ParameterException(
						"Parameter at index " + i + " is incorrect. " + mParamTypes.get(i).getSimpleName()
								+ " waited, but found " + parameters[i].getClass().getSimpleName());
			}
		}
